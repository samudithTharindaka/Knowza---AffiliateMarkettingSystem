...
foreach ($rows as $record ){//get data
    $indx = $record['indx'];
    $name=$record['name'];
    $mail= $record['email'];
    $nic=$record['nic'];
    $highrId=$record['higherId'];
    $team = $record['team'];
    $dob=$record['dob'];
    $gender=$record['gender'];
    $addr=$record['address'];
    $province= $record['province'];
    $pCode= $record['postalCode'];
break;
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">admin</li>
                                ...
                                <li class="breadcrumb-item active" aria-current="page">aproval request of <?php echo $name;  ?> </li>
                            </ol>
                          </nav>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
        <!-- ..........................anchor  tag....................... -->
      <th scope="row">Hgher ID</th>
      <td><?php echo $highrId;  ?></td>  
    </tr>
    <tr>
   ...
   <tr>
       <?php
       echo '<input type="hidden" name="indx" value="'. trim($indx)  . '"> </input>';
        echo '<input type="hidden" name="name" value="'. trim($name)  . '"> </input>';
       echo '<input type="hidden" name="email" value="'. trim($mail)  . '"> </input>';
       echo '<input type="hidden" name="nic" value="'. trim($nic) . '"> </input>';
       echo '<input type="hidden" name="higherId" value="'. trim($highrId) . '"> </input>';
       echo '<input type="hidden" name="team" value="'. trim($team) . '"> </input>';
       echo '<input type="hidden" name="dob" value="'. trim($dob) . '"> </input>';
       echo '<input type="hidden" name="gender" value="'. trim($gender) . '"> </input>';
       echo '<input type="hidden" name="addr" value="'. trim($addr) . '"> </input>';
       echo '<input type="hidden" name="province" value="'. trim($province) . '"> </input>';
       echo '<input type="hidden" name="pCode" value="'. trim($pCode) . '"> </input>';
...
<!--        <button type="submit" class="btn btn-success" name="submit" style="padding-right: 5px">Accept</button>-->
