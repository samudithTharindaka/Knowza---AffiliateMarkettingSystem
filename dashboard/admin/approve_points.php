...
<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="admin-panel.html" aria-expanded="false"><i
    ...
    <div class="page-wrapper">
      ...
      <td>" . $record['point_paid'] . "</td> 
    
      
      <td>
      <form action='../adding_points_logic/approve_points_controller.php' method='post'>";


      echo '<input type="hidden" name="user_id" value=" '. $record['user_id'] . '"> </input>
            <input type="hidden" name="indx" value=" '. $record['indx'] . '"> </input>
      <button type="submit" class="btn btn-success" name="accept" style="padding-right: 5px">Accept</button>
